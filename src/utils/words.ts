// Simple word list for the Wordle game
export const WORD_LIST = [
  ...
  'DELAY', 'DEPTH', 'DOING', 'DRAMA', 'DRANK', 'DREAM', 'DRESS', 'DRILL', 'DRINK', 'DRIVE',
  ...
  'TABLE', 'TAKEN', 'TASTE', 'TAXES', 'TEACH', 'TENDS', 'TERMS', 'TEXAS', 'THANK', 'THEFT',
  'THEIR', 'THEME', 'THERE', 'THESE', 'THICK', 'THING', 'THINK', 'THIRD', 'THOSE', 'THREE',
  'THREW', 'THROW', 'THUMB', 'THUS', 'TIGHT', 'TIRED', 'TISSUE', 'TITLE', 'TODAY', 'TOPIC',
  'TOTAL', 'TOUCH', 'TOUGH', 'TOWER', 'TRACK', 'TRADE', 'TRAIL', 'TRAIN', 'TRAIT', 'TREND',
  'TRIAL', 'TRIBE', 'TRICK', 'TRIED', 'TRIES', 'TRUCK', 'TRULY', 'TRUNK', 'TRUST', 'TRUTH',
  'TWICE', 'TWINS', 'TWIST', 'TYPED', 'UNCLE', 'UNDUE', 'UNION', 'UNITY', 'UNTIL', 'UPPER',
